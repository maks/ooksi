...
public class AppData implements HTTPResultListener {
	...
	private static final String WEB_APP_URL = Registry.get("site.url", "missing");
	...
	public static AppData parseDataString(String s) {
		JsArray toks = MIDPUtils.split(s, ",", 0);
		return new AppData(toks.getString(0), toks
